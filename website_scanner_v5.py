...
def main_scan_process(target_url):
    ...
    if ip_address and "Failed" not in ip_address and "Error" not in ip_address: advanced_port_scan(ip_address)
    else: print_status("Skipping Port Scan.", "info"); scan_report_data['port_scan'] = {'status': 'Skipped'}
